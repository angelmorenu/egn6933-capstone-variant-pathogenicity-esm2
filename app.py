...
with ESM2 embeddings. Designed for deployment and user-friendly access to variant pathogenicity predictions.

Single-Variant Scoring: Enter a canonical variant ID (e.g., chr1_100000_A_G) and get instant pathogenicity prediction
Batch CSV Upload: Upload a CSV file with multiple variants for ranked scoring
Performance Dashboard: View model metrics (AUROC, AUPRC, F1, ROC/PR curves)
Explainability: See feature importance and confidence breakdown for each prediction.
...
# Initialize session state variables for variant history and model/data caching
        ...
        if st.button("🔍 Score Variant", use_container_width=True):
            with st.spinner("Computing prediction..."):
                ...
                fig = px.bar(
                    ...
                    y='Feature',
                    orientation='h',
                    title="Top 10 Influential ESM2 Dimensions"
                )
...
# ============================================================================
# Performance dashboard and error analysis
# ============================================================================
...
# About section with project information and documentation
def about_section():
